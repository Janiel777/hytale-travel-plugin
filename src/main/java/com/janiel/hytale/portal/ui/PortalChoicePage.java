...
public final class PortalChoicePage extends ChoiceBasePage {
    ...
    private void travelToInstanceWorld(@Nonnull Store<EntityStore> store,
        ...
        InstanceReturnPointBridge.rememberReturnPoint(playerUuid, returnWorldUuid, returnTransform);
        ...
        InstanceReturnPointBridge.registerToWorld(currentWorld);
        ...
        instanceWorldFuture.thenAccept(InstanceReturnPointBridge::registerToWorld);
