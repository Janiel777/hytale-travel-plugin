...
public final class InstanceReturnBridge {
    ...
    public static void register(@Nonnull Object eventRegistry) {
        boolean drainOk = tryRegister(eventRegistry, "registerGlobal", DrainPlayerFromWorldEvent.class, InstanceReturnBridge::onDrain)
                || tryRegister(eventRegistry, "register", DrainPlayerFromWorldEvent.class, InstanceReturnBridge::onDrain);

        boolean addOk = tryRegister(eventRegistry, "registerGlobal", AddPlayerToWorldEvent.class, InstanceReturnBridge::onAdd)
                || tryRegister(eventRegistry, "register", AddPlayerToWorldEvent.class, InstanceReturnBridge::onAdd);
